...
- "dialogs": репліки по черзі, до 10 слів, тільки українська
- Персонаж може говорити лише після входу
- 5-7 сцен для повноцінного епізоду
...
Приклад сцени з beat і close_up:
{"background":"офіс","shot":"close_up","enter":[],"exit":[],"dialogs":[{"char":0,"text":"Я все зробив!","emotion":"talking","gesture":"explain"},{"beat":1.2,"emotion_char":1,"emotion":"surprised"}]}`;
