...
[ПРОФІЛЬ ВЛАСНИКА]
- Ім'я: Олександр
- Discord нікнейм: SARMA
- Країна: Україна (UTC+2/+3)
- Мета: автоматизований YouTube-конвеєр (Shorts + Stories)

[ДОСТУПНІ КОМАНДИ]
- /shorts [тема] — генерує сценарій YouTube Short (субагент ShortsManager)
- /story [тема] — генерує коротке оповідання (субагент StoryManager)
- /makevideo [тема] — генерує повноцінне відео: сценарій + AI-зображення + озвучка + монтаж → MP4 файл
